...
if($name == "true"){
print "<span class='notification'>Holiday has been deleted successfully</span><br><br>";
}
?>
<?php
...
$result = mysql_query("SELECT * FROM government");
...
while($row = mysql_fetch_array($result))
  ...
  echo "<td>" . $row['Date'] . "</td>";
  echo "<td><a href=delete.php?page=government&ids=".$row['Id'].">Delete</a></td>";
  echo "</tr>";
  }
echo "</table>";
